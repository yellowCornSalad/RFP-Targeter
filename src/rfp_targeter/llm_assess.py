...
2) biddable (위 회사가 '제안서·사업계획서를 작성해 응찰하거나 수주·수행'할 수 있는 사업인가):
   ...
   ★★ '주관기관/운영기관/수행기관 모집'에서 그 사업의 '운영·관리 기능'(창업지원·수출촉진·
      행사운영·마케팅·성과관리·실태조사·정책컨설팅 등)이 핵심이고 회사 본업과 무관하면
      biddable=false. 단 사업의 '기술 내용'이 보안·블록체인보안·전자증명·인증·디지털신원·
      개인정보·AI보안이면 회사가 수행 가능 → biddable=true. 막연한 '사업화·창업지원' 문구만으로
      과대평가하지 말되, 실제 보안 인접 기술(블록체인/전자증명/인증 등)은 정당하게 인정할 것.

3) relevance (도메인 적합성 — 회사 본업과의 거리):
   - high: 보안·취약점·침투·모의해킹·정보보호·AI보안·관제 등 본업 직결
   - medium: 일반 AI/SW/데이터/클라우드/블록체인/전자증명/인증/디지털신원/핀테크보안 R&D (보안과 인접, 컨소시엄·직접 수행 여지)
