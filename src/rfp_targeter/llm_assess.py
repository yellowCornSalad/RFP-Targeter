...
2) biddable (위 회사가 '제안서·사업계획서를 작성해 응찰하거나 수주·수행'할 수 있는 사업인가):
   ...
   ★★ '주관기관/운영기관/수행기관/전담기관 모집'은 그 사업을 운영·관리할 기관을 뽑는 것.
      사업 도메인(창업지원·바우처·오픈이노베이션·행사운영·마케팅 등)이 회사 본업(사이버보안)과
      무관하면 회사는 운영자로 부적합 → biddable=false, relevance=none/low(사업 도메인 기준).
      '사업화·창업·기술지원·시장검증' 같은 일반 문구를 회사의 보안제품 사업화 전략과
      억지로 연결하지 말 것 — 회사가 그 사업의 '대상(수혜기업)'이 아니라 '운영자'를 뽑는 것.
